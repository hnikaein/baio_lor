...
//const unsigned int CHUNK_SIZES[] = {1 <<9 , 1<< 10, 1 << 11, 1<< 12, 1 << 13,1 << 14, 1 << 15};
//const unsigned int SKETCH_SIZES[] = {1 << 7, 1<< 7, 1 << 8, 1<< 8, 1 << 9, 1<<9,  1 << 10};
...
#define READS_FILE_NAME_DEFAULT     BASE_FILE_NAME ".reads1.fastq"
